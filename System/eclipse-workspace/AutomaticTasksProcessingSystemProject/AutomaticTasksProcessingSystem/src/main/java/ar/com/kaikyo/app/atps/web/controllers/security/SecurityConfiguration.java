 ...
 */
package ar.com.kaikyo.app.atps.web.controllers.security;
...
import ar.com.kaikyo.app.atps.web.controllers.security.handlers.CustomAuthenticationFailureHandler;
import ar.com.kaikyo.app.atps.web.controllers.security.handlers.CustomLogoutSuccessHandler;
...
public class SecurityConfiguration {
	...
	protected SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		http.authorizeHttpRequests(auth -> auth
				...
				.requestMatchers("/system-control").hasAnyAuthority("ADMIN", "USER", "OBSERVER")
